...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> _submit() async {
    ...
    if (firstName.isEmpty ||
        ...
        password.isEmpty) {
      if (mounted)
        setState(() => _errorMessage = "auth.signup.error_fill_all".tr());
      return;
    }

    if (password.length < 6) {
      if (mounted)
        setState(() => _errorMessage = "auth.signup.error_pass_length".tr());
      return;
    }
                    ...
                    child: Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          labelText: 'auth.signup.first_name'.tr(),
